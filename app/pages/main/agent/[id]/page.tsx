...
export default function DriverDetail() {
  ...
  const editnavigate = dashboard_navigation.Agents.subRoutes.edit
    ? dashboard_navigation.Agents.subRoutes.edit
    : "";

  return (
    <DashboardLayout title="Jhon Doe" optionalTitle="Agent">
