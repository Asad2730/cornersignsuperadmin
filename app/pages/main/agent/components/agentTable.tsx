...
import { agents } from "../temp/agentsList";
...
export const AgentsTable = () => {
  ...
  const navigate = (id:string) => router.push(dashboard_navigation.Agents.subRoutes.detail(id))
  
  const editnavigate = dashboard_navigation.Agents.subRoutes.edit?dashboard_navigation.Agents.subRoutes.edit:''
            ...
            <table className="w-full min-w-[640px]">
              <thead className="bg-[#EEF5F5]">
                <tr className="text-left text-[#000637] text-xs sm:text-sm leading-normal whitespace-nowrap">
                  ...
                  <th className="py-3 px-2 sm:px-4">Agent Name</th>
